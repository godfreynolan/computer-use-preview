...
input_messages = [
    {
        "role": "user",
        "content": "Open riis.com, go to the contact us page and enter Godfrey Nolan, godfrey@riis.com and enter the message hello from the openai meetup. Click on the submit button."
    }
]
